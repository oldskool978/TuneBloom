(function (window) {
  ...
  registry.register({
    ...
    blocks: [
      ...
      { id: "b_met_8", type: "instrumental", label: "Breakdown", text: "BREAK THE MATRIX!\n(BLEGH!)\n(Break!)\n(Shatter!)\n(DIE!)" },
  ...
  registry.register({
    ...
    blocks: [
      ...
      { id: "b_orc_8", type: "instrumental", label: "Breakdown", text: "In silentio noctis\nGloria in excelsis deo\nSanctus, sanctus, requiem aeternam\nLight descending on the brave\n(Aeterna...)" },
