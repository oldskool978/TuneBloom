...
class FurgieEngine:
    ...
    def synthesize(
        ...
        input_sr_anchor: Optional[int] = None,
        ...
        return {
            ...
            "peak_dbfs_44k1": telemetry.peak_dbfs_44k1,
            "true_peak_dbtp_44k1": telemetry.true_peak_dbtp_44k1,
            "master_gain_scalar_44k1": telemetry.master_gain_scalar_44k1,
        }