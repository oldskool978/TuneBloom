...
class MiniMaxMusic3Vocoder(nn.Module):
    def __init__(
        ...
        self.snake_out = MiniMaxMusic3Snake1d(decoder_hidden_dim // (2 ** len(upsampling_ratios)))
        self.conv_out = weight_norm(nn.Conv1d(decoder_hidden_dim // (2 ** len(upsampling_ratios)), 1, kernel_size=7, padding=3))
